...
class ColdCalls extends StatefulWidget {
  const ColdCalls({super.key});

  @override
  State<ColdCalls> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<ColdCalls> {
                                  ...
                                  showMenu(
                                    ...
                                    if (value != null) {
                                      if (value == "Export") {
                                        ...
                                        Navigator.pushNamed(
                                            context, "/coldAdvanceSearch");
                                      } else if (value == "Create Group") {
                                        Navigator.pushNamed(
                                            context, "/coldCreateGroup");
                                      }
                                    }
                                  });
                                },
